...
function reservations_form_shortcode($atts){
	...
	if(ICL_LANGUAGE_CODE=='en')
		$theForm = stripslashes (get_option("reservations_form"));
			...
			$theForm = stripslashes (get_option("reservations_form_ja"));
		$formname = '';
