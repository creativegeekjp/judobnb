...
function jumpto(x){ // Chained inputs;
	...
	if(x == "form"){
		var FieldAdd = '<tr>';
			...
			FieldAdd += '<td><input type="text" id="easyreservation_form_val_message" name="easyreservation_form_val_message" style="width: 250px;padding:3px;font-size:13px" value="<?php echo _e('Reservation successfully verified','easyReservations'); ?>"></td>';
			FieldAdd += '</tr>';
			FieldAdd += '<tr>';
			...
			FieldAdd += '<td><input type="text" id="easyreservation_form_submit_message" name="easyreservation_form_submit_message" style="width: 250px;padding:3px;font-size:13px" value="<?php echo _e('Reservation successfully sent','easyReservations'); ?>"></td>';
			FieldAdd += '</tr>';
			FieldAdd += '<tr>';
			...
			FieldAdd += '<td><textarea id="easyreservation_form_submit_submessage" name="easyreservation_form_submit_submessage" style="width: 250px;padding:3px;font-size:13px"> <?php echo _e('Please continue by paying through PayPal or enter your credit card details.','easyReservations'); ?></textarea></td>';
			FieldAdd += '</tr>';
			FieldAdd += '</tr>';
