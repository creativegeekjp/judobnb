<form action="<?php bp_messages_form_action('compose'); ?>" method="post" id="send_message_form" class="standard-form" role="main" enctype="multipart/form-data">
	...
	<label for="content"><?php _e( 'Message', 'buddypress'); ?> <a href="https://www.googleapis.com/language/translate/v2?key=AIzaSyCHNLSGgYEq5_jXXBIkYoZ9nnH3_acs8gQ&q=hello%20world&source=en&target=de" style="float: right;"><button>translate</button></a></label>
