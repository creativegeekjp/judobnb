function validate_field(field){
	...
	if(is_error)
	{
		...
		jQuery(field).closest('.required_field').find('span.input-required').css("background-color", "#ff6600");
		jQuery(field).closest('.required_field').find('span.geodir_message_note').fadeOut();
		...
		jQuery(field).closest('.required_field').find('span.input-required').css("background-color", "#339933");
		jQuery(field).closest('.required_field').find('span.geodir_message_note').fadeIn();
