...
<div class="profile-editor">
	...
	<form class="pe-login-form" id="widget-login" action="" method="post">
		...
		<div class="checkbox">
			...
			<span class="checkbox_text"><?php _e( 'Remember me', 'profile-editor' ); ?></span>
			<input type="checkbox" id="pe-rememberme" class="rememberme" name="pe-rememberme" style="display: none">
		</div>
		<div class="clearfix"></div>
		<a href="<?php echo wp_lostpassword_url(); ?>" class="pe-forgotpass"><?php _e( 'Forgot password?', 'profile-editor' ); ?></a>
